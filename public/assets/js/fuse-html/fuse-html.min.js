...
! function(e) {
    ...
    function u() {
        var i, a, o, s;
        t = e("body"), r = f(), c(), e(window).on("resize", (i = function() {
            r = f(), e(window).trigger("fuse::windowResized", [r, p, l]), d !== r && c()
        }, a = 400, function() {
            var e = this,
                n = arguments,
                t = o && !s;
            clearTimeout(s), s = setTimeout(function() {
                s = null, o || i.apply(e, n)
            }, a), t && i.apply(e, n)
        })), n = {
            watchMatchMedia: u,
            triggerMatchMediaChanged: c,
            getCurrentStep: f,
            isOrAbove: l,
            isOrBelow: p
    ...
    function f() {
        ...
        return e.each(a, function(e, n) {
            !i && window.matchMedia(n).matches && (t = e, i = !0)
        }), t
    }

    function c() {
        t.addClass("media-step-" + r), t.removeClass("media-step-" + d), d = r, e(window).trigger("fuse::matchMediaChanged", [r, p, l])
    }

    function l(e) {
        return i.indexOf(e) <= i.indexOf(r)
    }
        ...
        o = {
            input: function(e) {
                ...
                if ("span" !== n.tagName.toLowerCase() || !n.classList.contains("fuse-ripple-ready")) {
                    ...
                    t.className = e.className + " fuse-ripple-input-wrapper", e.className = "fuse-ripple-input", n.replaceChild(t, e), t.appendChild(e)
                }
            },
            img: function(e) {
                var n = e.parentNode;
                if ("span" !== n.tagName.toLowerCase() || !n.classList.contains("fuse-ripple-ready")) {
                    var t = i.createElement("span");
                    n.replaceChild(t, e), t.appendChild(e)
                }
            }
        };

    function s(e, n) {
        this.element = e, this.options = b.extend({}, a, n), this._defaults = a, this._name = t, this.init()
    }
    s.prototype = {
        init: function() {
            i.body;
            var n, t = this;
            n = t.element;
            var e = t.element.tagName.toLowerCase(); - 1 !== ["input", "img"].indexOf(e) && (o[e](t.element), n = t.element.parentElement), b(n).hasClass("fuse-ripple-ready") || b(n).addClass("fuse-ripple-ready"), n.addEventListener("mousedown", function(e) {
                e.stopPropagation(), t.triggerRipple(n, t.options, e)
            })
        },
        triggerRipple: function(e, n, t) {
            var i = b(e);
            0 < i.find(".fuse-ripple").length && i.find(".fuse-ripple").remove();
            var a = b('<div class="fuse-ripple">'),
                o = i.offset(),
                s = 0,
                r = 0;
            "touches" in t && t.touches.length ? (s = t.touches[0].pageY - o.top, r = t.touches[0].pageX - o.left) : (s = t.pageY - o.top, r = t.pageX - o.left);
            var d = i.outerWidth(),
                u = i.outerHeight(),
                f = Math.sqrt(Math.pow(d, 2) + Math.pow(u, 2)),
                c = .6 * Math.max(d, u),
                l = "translate(" + parseInt(r - c / 2) + "px ," + parseInt(s - c / 2) + "px)";
            n.fromCenter && (l = "translate(" + parseInt(.2 * d) + "px ," + parseInt(.2 * u) + "px)");
            var p = "scale(1) " + l,
                m = f / c,
                h = "scale(" + m + ")" + " " + ("translate(" + .5 * (d - c) / m + "px ," + .5 * (u - c) / m + "px)"),
                g = "opacity " + n.duration + "ms linear, transform  " + n.duration + "ms cubic-bezier(0.4, 0, 0.2, 1)";
            n.fromCenter;
            var v = {
                    width: c + "px",
                    height: c + "px",
            ...
            b(a).css(v), i.append(a), setTimeout(function() {
                b(a).css(w)
            }), setTimeout(function() {
                i.find(a).remove()
            }, n.duration)
        ...
        return this.each(function() {
            b.data(this, "plugin_" + t) || b.data(this, "plugin_" + t, new s(this, e))
        })
    }
...
function(a) {
    ...
    function r(e) {
        0 !== e.val().length ? t(e) : e.removeClass("md-has-value")
    }

    function t(e) {
        e.addClass("md-has-value")
    }
    a.fn.fuseMdInput = function() {
        ! function(e) {
            for (var n, t = e, i = 0; n = t[i]; i++) r(a(n));
            t.on("blur", o), t.on("focus", s)
        }(this)
    }
}(jQuery),
function(a) {
    ...
    function i() {
        c("", "fuse-aside-expanded"), o = !1, e("fuse::asideExpanded", [])
    }

    function r() {
        c("fuse-aside-expanded", ""), o = !0, e("fuse::asideCollapsed", [])
    }

    function d() {
        o ? n.expand() : n.collapse()
    }

    function u() {
        s ? f() : function() {
            if (s) return;
            r(), s = !0, c("", "fuse-aside-folded"), a("body").addClass("fuse-aside-folded"), e("fuse::asideFolded", [])
        }()
    }

    function f() {
        s && (i(), s = !1, c("fuse-aside-folded", ""), e("fuse::asideUnfolded", []))
    }

    function c(e, n) {
        a("body").removeClass(e).addClass(n)
    }

    function e(e, n) {
        setTimeout(function() {
            a(window).trigger(e, n)
        }, 300)
    }
    a("document").ready(function() {
        ...
        e = a("#aside"), t = e, n = {
            ...
            toggle: d,
            toggleFold: u
        }, window.fuseAside = n, a("[data-fuse-aside-toggle-fold]").on("click", function() {
            u()
        }), t.on("mouseenter touchstart", function() {
            s && o && i()
        }), a(document).on("mousemove touchstart", function(e) {
            t.is(e.target) || 0 !== t.has(e.target).length || s && !o && r()
        })
    }), a(window).on("fuse::matchMediaChanged", function(e, n, t, i) {
        window.fuseAside || (t("md") ? c("fuse-aside-folded", "") : a("body").hasClass("fuse-aside-folded") && (o = s = !0)), t("md") && f()
    })
}(jQuery),
function(o) {
    var s, r = !1;
    ...
    function d(e) {
        return s.instances[e]
    }

    function n(e) {
        var n, t = d(e);
        t.isActive && (t.opened ? i(e) : (n = e, a().then(function() {
            var e = d(n);
            e.el.css({
                transform: "translate3D(0,0,0)"
            }), e.el.removeClass("fuse-bar-closed"), e.el.addClass("fuse-bar-open"), e.opened = !0, (r = o('<div class="fuse-bar-backdrop fuse-bar-backdrop-' + n.replace(" ", "-") + '"></div>')).hide(), e.el.after(r), r.fadeIn(), r.on("click", function(e) {
                e.preventDefault(), e.stopPropagation(), i(n)
            }), f("fuse::barOpened", [n, e])
        })))
    }
    ...
    function i(e, n) {
        ...
        function a() {
            i.el.removeClass("fuse-bar-open"), i.el.addClass("fuse-bar-closed"), t.resolve("closed")
        }
        return i.el.css({
            transform: ""
        }), n ? a() : setTimeout(a, 300), i.opened = !1, r && r.fadeOut(function() {
            o(this).remove()
        }), f("fuse::barClosed", [e, i]), t.promise()
    }
    ...
    function e(e, n, t, i) {
        o.each(s.instances, function(e, n) {
            u(n)
        }), a()
    }
    ...
    function u(e) {
        var n;
        e.mediaStep ? window.fuseMatchMedia.isOrBelow(e.mediaStep) ? t(e) : ((n = e).el.removeClass("fuse-bar"), n.el.removeClass("position-" + n.position), n.isActive = !1, f("fuse::barDestroy", [n.id, n])) : (t(e), i(e.id, !0))
    }

    function a() {
        var t = [];
        return o.each(s.instances, function(e, n) {
            n.opened && t.push(i(e))
        }), o.when.apply(o, t)
    }
    ...
    window.fuseBar = s = {
        ...
        o("[data-fuse-bar]").each(function(e) {
            var n, t, i, a;
            n = o(this), t = n.data("fuse-bar"), i = n.data("fuse-bar-media-step"), a = n.data("fuse-bar-position"), s.instances[t] = {
                id: t,
                el: n,
                mediaStep: i || !1,
                opened: !1,
        ...
        }), o("[data-fuse-bar-toggle]").on("click", function(e) {
            n(o(this).data("fuse-bar-toggle"))
        }), o("[data-fuse-bar-close]").on("click", function(e) {
            i(o(this).data("fuse-bar-close"))
        }), o(window).on("fuse::matchMediaChanged", e)
