...
use App\Service\Admin\Chiliman\Mum02_publicService;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Session;
use Libraries\Chiliman\BackendControllerAbstract;

class Mum02_publicController extends BackendControllerAbstract
{
    protected $service;

    public function __construct(Mum02_publicService $service)
    {
        $url = '/admin/mum02_public';
