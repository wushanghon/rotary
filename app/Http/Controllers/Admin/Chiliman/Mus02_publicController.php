...
use App\Service\Admin\Chiliman\Mus02_publicService;
...
class Mus02_publicController extends Controller
{
    ...
    public function index($gp_id, Request $request)
    {
        ...
        $this->bindingWith('refererUrl', '/admin/mum02_public');
