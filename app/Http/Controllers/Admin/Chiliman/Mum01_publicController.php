...
use App\Service\Admin\Chiliman\Mum01_publicService;
...
class Mum01_publicController extends BackendControllerAbstract
{
    //自訂變數
    ...
    public function queryCode()
    {
        ...
        $groupList = $this->mum02Service->queryGroupPublic();
